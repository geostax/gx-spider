...
public class BinzhouLeg implements Runnable{
	...
	public BinzhouLeg(String leg_id, DomainSpider spider, boolean feed) {
		this.leg_id = leg_id;
		this.spider = spider;
	...
	public void parse(Document doc) {
		...
		IndexResponse response = client.prepareIndex("binzhou", "page").setSource(infoMap).execute().actionGet();
