 ...
 * http://blog.locut.us/2008/01/12/a-decent-stand-alone-java-bloom-filter-
 * implementation/
 *
 * @param <E>
...
public class BloomFilter<E> implements Serializable {
	...
	public static void main(String[] args) {
		 BloomFilter<String> bf = new BloomFilter<String>(0.001, 100000);
		 bf.add("https://raw.githubusercontent.com/MagnusS/Java-BloomFilter/master/src/com/skjegstad/utils/BloomfilterBenchmark.java");
		 System.out.println(bf.contains("https://raw.githubusercontent.com/MagnusS/Java-BloomFilter/master/src/com/skjegstad/utils/BloomfilterBenchmark.java"));
	}
}